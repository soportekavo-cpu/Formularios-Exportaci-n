              ...
              <div className="space-y-8 max-h-[70vh] overflow-y-auto pr-2">
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 items-end">
                    ...
                    <div className="space-y-1"><label className="text-sm font-medium text-muted-foreground">Diferencial ($)</label><input type="number" inputMode="decimal" name="differential" value={data.differential || ''} placeholder="Ej: 10, -15" onChange={handleChange} className="bg-background border border-input rounded-md px-3 py-2 w-full" /></div>
