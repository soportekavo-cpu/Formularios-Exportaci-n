...
export const PrintIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.72 13.829c-.24.03-.48.062-.72.096m.72-.096a42.415 42.415 0 0 1 10.56 0m-10.56 0L6.34 18m10.94-4.171c.24.03.48.062.72.096m-.72-.096L17.66 18m0 0 .229 2.523a1.125 1.125 0 0 1-1.12 1.227H7.231c-.662 0-1.18-.568-1.12-1.227L6.34 18m11.318 0c1.291.273 2.536.52 3.755.735a1.125 1.125 0 0 1 .97 1.284v-1.185c0-.663-.537-1.2-1.2-1.2H5.124c-.663 0-1.2.537-1.2 1.2v1.185a1.125 1.125 0 0 1 .97-1.284c1.22-.215 2.465-.462 3.755-.735m9.256 0-4.61-4.61a1.125 1.125 0 0 0-1.591 0L10.22 14.19m-4.47 0 4.61 4.61a1.125 1.125 0 0 0 1.591 0L15.78 9.81m-4.47 0-4.61-4.61a1.125 1.125 0 0 0-1.591 0L2.22 9.81" />
  </svg>
);
...
export const DocumentDuplicateIcon = ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 0 1-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75m9 9.375c.621 0 1.125-.504 1.125-1.125v-9.75a1.125 1.125 0 0 0-1.125-1.125h-9.75a1.125 1.125 0 0 0-1.125 1.125v9.75c0 .621.504 1.125 1.125 1.125h9.75Z" />
    </svg>
);
